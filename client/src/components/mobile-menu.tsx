      ...
      <div className={`fixed left-0 top-0 h-full w-80 surface shadow-xl transform transition-transform duration-300 ${
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-xl font-bold bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent animate-pulse">Academic Avenger LittleBit</h2>
            <Button
              variant="ghost"
              size="sm"
              onClick={onClose}
